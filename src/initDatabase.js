...
const ctgCrudService = require('./db/CategoryCrudService');
...
async function initDatabase() {
  try {
    ...
    products[1].categories = [allCtg[0].children[0].children[2], allCtg[0].children[1].children[4]];
    products[2].categories = [allCtg[1].children[0].children[1].children[0].children[4]];
